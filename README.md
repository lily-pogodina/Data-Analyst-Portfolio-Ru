...
<table>
  <tr>
   ...
   <tr>
    <td>1</td>
    <td><a href="https://github.com/lily-pogodina/Data-Analyst-Portfolio-Ru/tree/main/Bank_Customer_Churn_Analysis_ru">Анализ оттока клиентов банка.</a></td>
    <td> Выпускной проект курса. <br>
Определила ключевые факторы, влияющие на отток клиентов, выделила группы пользователей, которые с большей вероятностью могут уйти из банка. Для групп предложила адресные рекомендации, направленные на снижение уровня оттока клиентов.
    </td>
    <td><mark>Python</mark>, <mark>Pandas</mark>, <mark>Seaborn</mark>, <mark>предобработка</mark>, <mark>исследовательский анализ</mark>, <mark>верстка презентации</mark>, <mark>статистический анализ</mark> <mark>визуализация</mark></td>
  </tr>
   ...
   <tr>
    <td>3</td>
    <td><a href="https://github.com/lily-pogodina/Data-Analyst-Portfolio-Ru/tree/main/Moscow_public%20_catering_ru">Исследование рынка общественного питания Москвы.</a></td>
    <td>
Провела анализ рынка на основе набора данных, выявила основные тенденции и закономерности. Определила наиболее привлекательные районы Москвы для открытия кофейни, учитывая распределение по округам, типам заведений и ценовым категориям. Подготовила визуальную презентацию.
    </td>
    <td><mark>Python</mark>, <mark>Pandas</mark>, <mark>Seaborn</mark>, <mark>предобработка</mark>, <mark>исследовательский анализ</mark>, <mark>верстка презентации</mark>, <mark>визуализация</mark></td>
  </tr>

   <tr>
    <td>4</td>
    <td><a href="https://github.com/lily-pogodina/Data-Analyst-Portfolio-Ru/tree/main/A-A-B_testing_and_funnel_analysis_ru">Анализ результатов A/A/B-эксперимента и воронки событий по данным из журнала событий.</a></td>
    <td> Изучила воронку событий, проанализировать результаты A/A/B-теста и приняла решение о продолжении теста или его остановке.
    </td>
